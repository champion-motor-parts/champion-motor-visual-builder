...
export const threeDVariants: readonly ThreeDVariant[] = [
  ...
  ...(["mx_blue", "sniper_mx_2015_white_red"] as const).flatMap((coverSetId) =>
    (["matt_black", "gloss_black", "gold"] as const).map(
      (rimColorId): ThreeDVariant => ({
        ...
        modular: {
          ...
          coverSet:
            coverSetId === "mx_blue"
              ? "/models/y15zr/modular/coversets/coverset-mx-blue.glb"
              : "/models/y15zr/modular/coversets/coverset-sniper-mx-2015-white-red.glb",
